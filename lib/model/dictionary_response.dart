...
List<WordsModel> wordsModelFromJson(String str) =>
    List<WordsModel>.from(json.decode(str).map((x) => WordsModel.fromJson(x)));

String wordsModelToJson(List<WordsModel> data) =>
